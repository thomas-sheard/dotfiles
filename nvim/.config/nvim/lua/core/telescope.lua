...
vim.keymap.set('n', '<leader>ff', builtin.find_files, {}) -- ff to search files from pwd ('find files') 
--vim.keymap.set('n', '<leader>ff', function()builtin.find_files({cwd=utils.buffer_dir()})end, {}) -- ff to search files from buffer dir ('find files') 
